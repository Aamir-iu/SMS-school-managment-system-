...
class studentController extends Controller {
	...
	*/
	...
	if ($validator->fails())
	{
		...
		$student->regDate= Input::get('regDate');
		...
		$student->guardianCNIC= Input::get('guardianCNIC');
		$student->localGuardianCell= Input::get('localGuardianCell');
		$student->email_address=Input::get('email_address');
...
public function view($id)
{
	...
	->join('Class', 'Student.class', '=', 'Class.code')
	->select('Student.id', 'Student.regiNo','Student.rollNo','Student.firstName','Student.middleName','Student.lastName','Student.regDate','Student.email_address',
	'Student.fatherName','Student.motherName', 'Student.fatherCellNo','Student.motherCellNo','Student.localGuardianCell','Student.guardianCNIC',
...
public function edit($id)
{
	...
	return View("app.studentEdit",compact('student','classes'));
}
