...
class attendanceController extends Controller
{
    ...
    public function edit($id)
    {
        $attendance=DB::table('Attendance')
            ...
            ->first();
        return view('app.attendanceEdit', compact('attendance'));
    }
    ...
    public function monthlyReport()
    {
        ...
        if($isPrint) {
            ...
            $fullSql ="SELECT CONCAT(MAX(s.firstName),' ',MAX(s.middleName),' ',MAX(s.lastName)) as name,CAST(MAX(s.rollNo) as UNSIGNED) as rollNo,".$SelectCol." FROM Attendance as sa left join Student as s ON sa.regiNo=s.regiNo";
            ...
            return view('app.attendanceMonthlyReport', compact('institute', 'data', 'keys', 'yearMonth', 'fridays', 'holiDays', 'className', 'section', 'session', 'shift', 'offDays'));

        }
        return view('app.attendanceMonthly', compact('yearMonth', 'classes2'));
    }
