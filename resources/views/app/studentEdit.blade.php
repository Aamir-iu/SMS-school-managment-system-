                        ...
                        <form role="form" action="/student/update" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                                                <input type="text" value="{{$student->regDate}}"  class="form-control datepicker" name="regDate" required  data-date-format="dd/mm/yyyy">
                                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="localGuardianCell">Guardian CNIC </label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="text" class="form-control" value="{{$student->guardianCNIC}}" required name="guardianCNIC" placeholder="XXXXX-XXXXXXX-X">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="text" class="form-control"  value="{{$student->email_address}}"  name="localGuardianCell" placeholder="x@gmail.com">
                                            </div>
                                        </div>
                                    </div>
                            </div>
