                            ...
                            <div class="form-group ">
                                             <label for="dob">Registration Date</label>
                                                 <div class="input-group">
                                                  ...
                                                  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                                                    <input type="text"   class="form-control datepicker" name="regDate" required  data-date-format="dd/mm/yyyy">
                                                </div>
                  ...
                  <div class="col-md-12">
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                    <input type="text" class="form-control" required name="guardianCNIC" placeholder="XXXXX-XXXXXXX-X">
                                </div>
                            </div>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                    <input type="text" class="form-control"  name="email_address" placeholder="x@gmail.com">
                                </div>
                            </div>
                            </div>
                </div>
