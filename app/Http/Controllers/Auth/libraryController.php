...
class libraryController extends Controller {
	...
	{
		$classes = array('All'=>'All')+ClassModel::pluck('name','code')->toArray();
	...
	*/
	...
	public function postviewbook()
	{
		...
		// This to b resolved	
		// $books->$this->setBaseUrl('view-show')->toArray();
		$classes = array('All' => 'All')+ClassModel::pluck('name','code')->toArray();
		$formdata = new formfoo;
	...
	*/
	...
	{
		$students =['' => 'Select Student']+Student::select(DB::raw("CONCAT(firstName,' ',middleName,' ',lastName,'[',regiNo,']') as name,regiNo"))->pluck('name','regiNo')->toArray();
		$books = ['' => 'Select Book']+AddBook::select(DB::raw("CONCAT(title,'[',author,']') as name,code"))->pluck('name','code')->toArray();
