          ...
          @if (isset($student))
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-2"></div>
                <div class="col-md-3">
                  <strong class="text-info font-16" >Registration Date :</strong>
                </div>
                <div class="col-md-7">
                  <label>{{$student->regDate}}</label>
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-2"></div>
                <div class="col-md-3">
                  <strong class="text-info font-16" >Guardian CNIC :</strong>
                </div>
                <div class="col-md-7">
                  <label>{{$student->guardianCNIC}}</label>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-2"></div>
                <div class="col-md-3">
                  <strong class="text-info font-16" >Email Address :</strong>
                </div>
                <div class="col-md-7">
                  <label>{{$student->email_address}}</label>
                </div>
              </div>
            </div>
            <div class="row">
