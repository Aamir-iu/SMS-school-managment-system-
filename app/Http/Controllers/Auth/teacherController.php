...
class teacherController extends Controller {
    ...
    public function index()
    {
        ...
        return View('app.teacher.create');
    }
    ...
    public function show()
    {
        ...
        return View("app.teacher.list", compact('teachers'));
    ...
    public function view($id)
    {
        ...
        return View("app.teacher.details",compact('teacher','cl','ml','ul'));
    }
    /**
...
//            $teacher->regNo= Input::get('regNo');
    ...
    {
        return View('app.teacher.attendance_create');
    }
...
//        }
        ...
        $teachers = ['0'=>'All']+Teachers::select('regNo','fullName')->where('isActive',1)->orderby('regNo','asc')->pluck('fullName','regNo')->toArray();
        ...
        //     ));
        return View('app.teacher.attendanceList',
            compact('teachers','attendance','regNo','egroup','searchType',
                'dateFrom','dateTo','holiDays','empWorks'
            ));
    }
    ...
    public function absenteeismReport()
    {
        ...
        return View('app.teacher.absenteeism',compact('dateFrom','dateTo'));
    }/**
...
//            return $data;
        ...
        return View('app.teacher.monthly_attendance',compact('yearMonth'));
    }
    ...
    public function leaveIndex()
    {
        ...
        return View('app.teacher.leave.list',compact('leaves','teachers','employee','type','status'));
    }
    ...
    {
        $teachers = Teachers::select('regNo','fullName')->where('isActive',1)->orderby('regNo','asc')->pluck('fullName','regNo');
        // return View::Make('app.teacher.leave.create',compact('teachers'));
        return View('app.teacher.leave.create',compact('teachers'));
...
//        }
        ...
        return View('app.teacher.workoutside.list',compact('workOutsides','teachers','employee'));
    }
    ...
    public function workOutsideCreate()
    {
        ...
        return View('app.teacher.workoutside.create',compact('teachers'));
...
//    }
    ...
    public function monthlyAttendanceReport2()
    {
        ...
        return View('app.teacher.monthly_attendance_two',compact('yearMonth'));
    }
